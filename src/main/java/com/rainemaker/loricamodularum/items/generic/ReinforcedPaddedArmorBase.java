...
public abstract class ReinforcedPaddedArmorBase extends ArmorItem {
	public ReinforcedPaddedArmorBase(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "reinforced_padded_armor";
			}
	...
	public static class Helmet extends ReinforcedPaddedArmorBase {
		public Helmet() {
			super(EquipmentSlot.HEAD, new Item.Properties().tab(LoricaModularum.loricaTab));
			setRegistryName("reinforced_padded_helmet");
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "loricamodularum:textures/models/armor/reinforced_padded/lorica_layer_1.png";
		}
	}

	public static class Chestplate extends ReinforcedPaddedArmorBase {
		public Chestplate() {
			super(EquipmentSlot.CHEST, new Item.Properties().tab(LoricaModularum.loricaTab));
			setRegistryName("reinforced_padded_chestplate");
		}
	...
	public static class Leggings extends ReinforcedPaddedArmorBase {
		public Leggings() {
			super(EquipmentSlot.LEGS, new Item.Properties().tab(LoricaModularum.loricaTab));
			setRegistryName("reinforced_padded_leggings");
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "loricamodularum:textures/models/armor/reinforced_padded/lorica_layer_2.png";
		}
	}

	public static class Boots extends ReinforcedPaddedArmorBase {
		public Boots() {
			super(EquipmentSlot.FEET, new Item.Properties().tab(LoricaModularum.loricaTab));
			setRegistryName("reinforced_padded_boots");
		}
